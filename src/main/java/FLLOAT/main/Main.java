...
import FLLOAT.RuntimeVerification.ExecutableAutomaton;
...
public class Main {
    ...
    public static void ldlf2Aut() {
        ...
        //System.out.println(FLLOAT.formula);
    ...
    public static void ltlf2Aut() {
        ...
        Automaton construction method invocation
         */
        //Automaton FLLOAT.automaton = AutomatonUtils.ldlf2AutomatonDeclare(ldlff, ldlff.getSignature());
         ...
         */
        //FLLOAT.automaton = new ToDFA<>().transform(FLLOAT.automaton);
        //FLLOAT.automaton = AutomatonUtils.declareAssumption(FLLOAT.automaton);
        /*
        Minimization! WARNING! IT USE THE JAUTOMATA LIBRARY (not tested if works properly)!
         */
        ...
        //provaExecutableAutomaton(FLLOAT.automaton);
