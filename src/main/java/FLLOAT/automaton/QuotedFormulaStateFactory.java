...
public class QuotedFormulaStateFactory implements StateFactory, Cloneable {
     ...
     * (non-Javadoc)
     *
     * @see rationals.StateFactory#stateSet(java.simoneclr.util.Set)
     */
    ...
    /*
    In the FLLOAT.automaton building algorithm in AutomatonUtil, we should use this
    method to add a new state.
     */

    /**
     * It adds and return a new state ONLY IF there is no other state in the FLLOAT.automaton with the same
     * Set<QuotedVars>. Otherwise it returns the already existing state.
     * It calls FLLOAT.automaton.addState which, in turns, calls
...
//        QuotedFormulaState newState = (QuotedFormulaState) FLLOAT.automaton.addState(initial, terminal);
...
//                ds.initial = FLLOAT.automaton.initials().contains(ds);
//                ds.terminal = FLLOAT.automaton.terminals().contains(ds);
//                mods++;
//                modcount++;
//                if (mods != modcount)
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#size()
//         */
//        public int size() {
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#clear()
//         */
//        public void clear() {
//            modcount++;
//            bits.clear();
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#isEmpty()
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#toArray()
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#add(java.lang.Object)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#contains(java.lang.Object)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#remove(java.lang.Object)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#addAll(java.simoneclr.util.Collection)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#containsAll(java.simoneclr.util.Collection)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#removeAll(java.simoneclr.util.Collection)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#retainAll(java.simoneclr.util.Collection)
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#iterator()
//         */
...
//         * (non-Javadoc)
//         *
//         * @see java.simoneclr.util.Set#toArray(java.lang.Object[])
//         */
