...
public class PerformanceTests {
    ...
    public void declarePerformances() {
        ...
        for(String c : constraints) {
            ...
            */
            ...
            if (!firstIteration) {
                ...
                System.out.print("Intersecating FLLOAT.automaton for " + c + " with the product FLLOAT.automaton of the previous formulas, which has " + oldAutomaton.states().size() + "states and " + oldAutomaton.delta().size() + " transitions... ");
                // Synchronous product between the new FLLOAT.automaton and the result of the products of the others.
        ...
        System.out.println("*******************************");
        System.out.println("*******************************");
        System.out.println("Time for the declare FLLOAT.automaton: " + (stopTime-startTime));
        System.out.println("*******************************");
        System.out.println("*******************************");
    }
