...
import FLLOAT.formula.ldlf.*;
import FLLOAT.formula.quotedFormula.*;
...
public class DeltaFunctionTest {
    ...
    public void deltaAtomicTest() {
        ...
        // Try with a model of the FLLOAT.formula
        Set<PossibleWorld> models = pf.getModels();
        if (models.isEmpty())
            throw new RuntimeException("The specified FLLOAT.formula is unsatisfiable!");
        ...
        // Try with a non-model of the FLLOAT.formula
        ...
        if (nonModels.isEmpty())
            throw new RuntimeException("The specified FLLOAT.formula is a tautology!");
    ...
    public void deltaTestGeneric() {
        ...
        //Testing the models of the FLLOAT.formula:
