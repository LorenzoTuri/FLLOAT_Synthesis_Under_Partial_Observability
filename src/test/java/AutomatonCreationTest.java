...
//        LDLfFormula FLLOAT.formula = visitor.visit(tree);
//
//        Automaton FLLOAT.automaton = AutomatonUtils.ldlf2Automaton(FLLOAT.formula, FLLOAT.formula.getSignature());
//
//        System.out.println(FLLOAT.automaton);
//
//        Automaton transformed = new ToDFA<>().transform(FLLOAT.automaton);
//        System.out.println(transformed);
//
//        FileOutputStream fos = null;
//        try {
//            fos = new FileOutputStream("FLLOAT.automaton.gv");
...
//        Automaton FLLOAT.automaton = AutomatonUtils.ldlf2Automaton(FLLOAT.formula, FLLOAT.formula.getSignature());
//
//        FLLOAT.automaton = new ToDFA<>().transform(FLLOAT.automaton);
//
//        System.out.println("INPUT AUTOMATON: ");
//        System.out.println(FLLOAT.automaton);
//
//
//        //Building the FLLOAT.automaton to be intersected with "FLLOAT.automaton"
...
//
//        Automaton union = new Union<>().transform(FLLOAT.automaton, other);
